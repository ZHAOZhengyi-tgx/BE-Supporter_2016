...
#define ACSC_INVALID_FILETYPE       (ACSC_ERRORBASE+68) //File is not Data File
...
typedef int (WINAPI *ACSC_GetConnectionsList)(ACSC_CONNECTION_DESC*,int,int*);
typedef int (WINAPI *ACSC_TerminateConnection)(ACSC_CONNECTION_DESC*);
...
static int InitACSCLibrary()
{
    ...
    acsc_RegisterEmergencyStop = (ACSC_TerminateConnection) GetProcAddress(hACSCLibraryModule,"_acsc_RegisterEmergencyStop@0"); //     251
	acsc_UnregisterEmergencyStop = (ACSC_TerminateConnection) GetProcAddress(hACSCLibraryModule,"_acsc_UnregisterEmergencyStop@0"); // 252	
